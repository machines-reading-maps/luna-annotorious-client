...
export const redraw = (viewer: any, renderer: PIXI.AbstractRenderer, graphics: PIXI.Graphics, map: any) => () => {
  ...
  let dx = - (viewportBounds.x - map.imageRegion.x) * scale;
  let dy = - (viewportBounds.y - map.imageRegion.y) * scale;
